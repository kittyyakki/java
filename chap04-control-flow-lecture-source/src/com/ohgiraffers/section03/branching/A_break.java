...
public class A_break {
    ...
    * */
    ...
    while(true){
        ...
        i++;//while은 증감식 무조건 써주기.

    }
        System.out.println("1부터 100까의 합은 " + sum + "입니다.");

    }

    public void testSimpleBreakStatement2(){
        /* 수업목표. 중첩 반복문 내 break문 사용에 대한 흐름을 이애하고 적용할 수 있다.
        *  break문은 모든 반복문을 종료하는 것이 아닌 자신에세 가장 인접한 반복문의 실행을 멈춘다.*/
