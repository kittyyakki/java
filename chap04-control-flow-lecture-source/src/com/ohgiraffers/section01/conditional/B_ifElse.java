...
public class B_ifElse {
    ...
    public void simpleIfElseStatement(){
        /*수엄목표. if-else문 단독 사용에 대한 흐름을 이해하고 적용할 수 있다.
        *  [if-else표현식]
        *  if(조건식){
        ...
        *
        *  정수 한개를 입력받아 그 수가 홀수이면 "입력하신 숫자는 홀수 입니다"를 출력하고
        *  홀수가 아니면 "입력하신 숫자는 짝수입니다"를 출력한는 프로그램을 작성해보자
        *  단, 조건과 상관없이 프로그램이 종료할 때 "프로그램을 종료합니다"라고 출력되도록 한다.
        * */

        Scanner sc = new Scanner(System.in);
        System.out.print("숫자를 하나 입력해주세요 :"); //이거 위에다 해줘야함 중요!
        int num = sc.nextInt();
    ...
    public void testNeatedIfElseStatement(){
        ...
        *  조건과 상관없이 프로그램이 종료할 때 "프로그램을 종료합니다"라고 출력되도록 한다. */
        ...
        Scanner sc = new Scanner(System.in);
        System.out.print("정수 하나늘 입력해주세요 ");
        int num = sc.nextInt();
