...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        StaticFieldTest sft = new StaticFieldTest(); //public으로 안막혀있으니 new로 접근가능.
        ...
        /* 인스턴스 변수의 경우에는 stf와 stf2도 두 개의 인스턴스가 서로의 값을 공유하지 못하고
        *  인스턴스가 생성할 때마다 0으로 초기화 되었다.
        *  static 필드의 경우에는 클래스 변수 자체가 프로그램이 종료할 때까지 유지되고 있기 때문에
        *  값을 유지하고 있다.
        *  따라서 여러개의 인스턴스가 같은 값을(공간)을 공유할 목적으로 static 키워드를 사용한다.
        * */
        ...
        StaticMethodTest.staticMethod(); //이것이 static method를 불러오는 것의 권장사항
