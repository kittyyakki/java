...
public class OverloadingTest {
    ...
    * 동일한 이름으로 관리하기 위해서 사용는 기술을 오버로딩이라고 한다.
    *
    * */
   ...
   /* public int test(){      //에러발생 반환형은 메소드 시그니처에 해당하지 않는다.
        return 0;
    }*/

    public void test(int num){}  //파라미터의 선언부는 메소드 시그니처에 해당합니다.

    //public void test(int num2){}  //에러발생 ..매개변수의 이름은 메소드 시그니처에 영향을 주지 않는다.

    public void test(int num,int num2){} //매개변수 갯수에 따른 오버로딩 확인
    public void test(int num,String name){} //메개변수 타입에 따른 오버로딩 확인
