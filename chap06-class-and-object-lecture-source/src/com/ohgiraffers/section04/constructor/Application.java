...
public class Application {
    public static void main(String[] args) {
        ...
        *  기본생성자는 compiler에서 자동으로 추가되기 때문에 지금껏 명시적으로 작성하지 읺고 사용할 수 있었다.
        ...
        * */
        ...
        /*매개변수를 전달 받는 생성자를 호출해 인스턴스 생성후 필드값 출력*/
        User user2 = new User("user01","pass01","선덕여왕");
        System.out.println(user2.getinformation()); //매개변수를 전달받는 생성자 위에 User명시를 꼭 해줘야함!!
    }
