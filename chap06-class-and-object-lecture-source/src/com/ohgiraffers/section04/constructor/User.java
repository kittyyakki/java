...
public class User {
    ...
    /*
    * 생성자의 작성 위치
    * 작성 위치는 문접상으로는 클래스 내부에 작성하면 되지만
    ...
    * */
    ...
    public User(){
        ...
        *  호출 확인을 위한 출력구문만 작성해보다
        *  메소드와 같이 수행할 명령들을 작성할 수 있다.
        *  ex)setter(반환값없음)들을 받아올때?
        * */

        System.out.println("기본 생성자 호출함...");

    } //매개변수있는 생성자 사용하기 위한 기본생성자 호출구문


    /* 주의사항. 동일한 이름의 생성자 혹은 메소드를 한 클래스 안에서 작성하는 것은 불가능하다.*/
    //public User(){}
