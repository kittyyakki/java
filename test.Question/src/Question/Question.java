...
public class Question {
    ...
    * Application을 만들고
    * 1. 기본자료형 8가지를 선언 및 초기화 해주세요(0 제외 아무값)
    * 2. 정수 int의 값을 long타입과 합하여 주세요
    * 3. 삼항연산자를 이용하여 2.의 합걔를 0보다 클 때 양수입니다 0보다 작을 때
    * 음수입니다 표기해주세요
    *
    * TestMethod을 만들고
    *
    * 1. 인자값을 전달받아 사친연산과 나머지 계산을 하는
    *  매개변수를 전달받는 메소드를 만들어 주세요 메소드 이름 Calculator
    *  춯력구문 필요
    * 2. final키워드를 이용한 실수 값 3.14를 초기화하고
    * 반지름 값을 입력 받아 실수형태로 값을 변수로 받아
    * 리턴받는 CircleArea메소드를 만들어주세요
    *
    ...
    * 2.TestMethod의 CircleArea를 원의 부피는 **입니다를 출력하는 구문을 만들어주세요
