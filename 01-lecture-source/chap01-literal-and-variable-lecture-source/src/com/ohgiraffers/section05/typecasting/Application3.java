...
public class Application3 {
    public static void main(String[] args) {
        ...
        *
        *  자동 형변환과 강제 형변관을 이용한 다른 자료형끼리 연산
        *  다른 자료형끼리의 연산은 큰 자료형으로 자동 형변환후 연산처리된다.
        *
        *  */
        ...
        //int isum = inum + lnum;
        int isum = (int)(inum + lnum); //(int)(long으로 계산후)int변환

        /* 목차 2. long형 값을 int로 강제 형변환한다.*/
        int isum2 = inum + (int)lnum; //inum+(int)(long으로 계산)

        /* 목차 3. 결과값을 long으로 받는다. (자동현변환 이용)*/
        long lsum = inum + lnum;
