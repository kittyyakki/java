...
public class Application2 {
    ...
    public static void main(String[] args){
        ...
        System.out.println(3 % 2);//홀수 찾을때 많이씀 짝수는 무조건 0으로 남기때문에
        ...
        * */
        ...
        /* 결론 문자는 내부적으로 숫자취급. 결국 정수와 실수의 값은 수학의 사칙연산 나머지값 모두 가능하다는 점*/
        ...
        /*3-2-2 문자열과 실수의 계산*/
        System.out.println("helloworld" + 1.2332424);
        /*3-2-3 문자열과 문자의 연산*/
        ...
        System.out.println("============문자열 형태의 숫자와 '+' 연산=============");
        System.out.println("123" + "456");
    ...
    /*    System.out.println(true +0.1);
        ...
        /* 이유는 문자는 내부적으로 숫자로 취급하기 때문에 결국 논리값과 숫자 연산과 동일하다 /유니코드 아스키코드*/
