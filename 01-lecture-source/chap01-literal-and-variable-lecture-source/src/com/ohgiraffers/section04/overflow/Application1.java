...
public class Application1 {
    public static void main(String[] args){
        ...
        *  발생한 carry를 버림 처리하고 sign byte(byte는 1byte (-128~ +127)
        *  를 반전시켜 최소값으로 순환시킴*/
        ...
        *  오버플로우를 예측하고 더 큰 자료형으로 결과값을 받아서 처리한다. */
        ...
        System.out.println("firstNum * secondNum =" + longMulti ); //안됨

        long result = (long)firstNum * secondNum; //강제형 변환 오버플로우 되기전에 long으로 변환시켜 더 큰 수 받게함
