...
public class Apllication3 {
    public static void main(String[] args){
        ...
        *  1-3. 변수명은 대/소문자를 구분한다(자바는 대/소문자를 구문하는 언어이다)
        *  1-4. 변수명은 숫자로 시작할 수 없다(시작만 할 수 없고 숫자를 섞어서 사용할 수 있다)
        ...
        * */
        ...
        int age = 20;
        //String age = ""; //문자형도 안됨 이름이 같기 때문에!!
        //int age = 30; //동일한 변수명을 가지므로 에러 발생

        /* 목차 1-2 예약어는 사용이 불가능하다. */
        //int true =1; //true논리형 예약어기 때문에 사용이 불가능하다.

        /* 목차 1-3 변수명은 대소문자를 구분한다.*/
        int Age = 20;  //위에서 만든 age와 다른것으로 취급해서 사용 가능하다.
        int True = 10; //예약어는 true이기 때문에 대문자로 다른 취급으로 사용 가능하다.
        ...
        //int a@ge = 20;  //에러발생
        int _age = 20;   //_는 처음도 가능 중간도 가능
        int a$ge =20;   //$ 위와같음

        //컴퓨터가 다 알려줌 맞는지 틀렸는지 네이밍.

        /* 2. 컴파일 에러를 발생시키지는 않지만 개발자들끼리의 암묵적인 규칙 */
        /* 목차 2-1 변수명의 길이제한은 없다. 하지만 적당히 하자. */
        int asdfsdkfjlsdfjsdfkjsldfkjsldfddsfsdfsdfsdfdsfssdlkfjsdlkf = 20;

        /* 목차 2-2. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자 두 번째 시작 단어는 대문자로 시작한다 */
        /* 자바에서는 클래스명만 유일하게 대문자로 시작한다. */ //카멜표기법

        int maxAge = 30;
        int minAgeFemale = 10;

        /* 목차 2-3 단어와 단어 사이는 '_'로 하지 않는다 */
        ...
        boolean isDeath = false;  //부정형보다 긍정형이 더 나은 방식이다.
