...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        Random random = new Random(); //선언을 해줘야함!
        ...
        /* 4. -128 ~ 127까지의 byte범위 난수발생 */
        //int randomNum3 = random.nextInt(256) -128;
        int randomNum3 = new Random().nextInt(256) -128; //객체를 생성하자마자 바로 메소드 호출가능.
        System.out.println("-128~127까지의 난수 발생 : " + randomNum3);
