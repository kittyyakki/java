...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        * */
        ...
        System.out.println("inum1과 inum2가 같은지 비교 " + (inum1 == inum2)); //같다
        System.out.println("inum1과 inum2가 다른지 비교 " + (inum1 != inum2)); //같지않다
        ...
        System.out.println("dnum1과 dnum2가 같은지 비교 " + (dnum1 == dnum2)); //같다
        System.out.println("dnum1과 dnum2가 다른지 비교 " + (dnum1 != dnum2)); //같지않다
        ...
        System.out.println("ch1과 ch2가 같은지 비교 " + (ch1 == ch2)); //같다
        System.out.println("ch1과 ch2가 다른지 비교 " + (ch1 != ch2)); //같지않다
        ...
        /* 3. 논리값 비교 */
        /* ==과 !=은 비교가능하지만 대소비교는 불가능하다.*/

        boolean bool1 = true;
        boolean bool2 = false;

        System.out.println("==========논리값 비교===========");
        System.out.println("bool1과 bool2가 같은지 비교 " + (bool1 == bool2)); //같다
        System.out.println("bool1과 bool2가 같지 않은지 비교 " + (bool1 != bool2)); //같지않다
        //System.out.println("bool1이 bool2보다 큰지 비교 " + (bool1 > bool2)); //비교불가.참 거짓.
        ...
        System.out.println("str1과 str2과 같은지 비교 " + (str1 == str2)); //같
        System.out.println("str1과 str2과 다른지 비교 " + (str1 != str2)); //같지않다
        //System.out.println("str1과 str2가 큰지 비교 " + (str1 > str2)); // 대입연산자는 자료형이나 결과는 boolean이다(true false나오기 때문에)
