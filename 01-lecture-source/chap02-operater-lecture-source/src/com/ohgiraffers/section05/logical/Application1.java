...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 1-1. &&(논리AND) 연산자 : 두 개의 논리식이 모든 참일 경우 참을 반환 둘 중에 한 개라도 거짓인 경우 거짓을 반환.
        * 1-2. || (논리OR) 연산자 : 두 개의 논리식 중 둘 중 하나라도 참인 경우 참을 반환 둘 다 거짓일 경우 거짓을 반환.
        * 2. 논리 부정 연산자 : 피연산자가 하나인 단항연산자로, 피 연산자의 결항 방향은 왼쪽에서 오른쪽이다.
        *  2-1 !(논리NOT)연산자 : 논리의 결과가 참이면 거짓을, 거짓이면 참을 반환
        * */

        /* 논리 연산자 결과값 확인*/
        System.out.println("true와 true의 논리 and 연산 : " + (true && true)); //두값이 모두 true여야 참나옴.
