...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        int[] iarr;
        char carr[]; //자료형 상관없이 모든것 다 배열로 가능

        /* 선언한 레퍼런스 변수에 배열을 할당하고 대입할 수 있다
        *  new 연산자는 heap영역에 공간을 할빙하고 발생한 주소값을 반환하는 연산자이다.
        ...
        * */
        ...
        System.out.print("새로 할당할 배열이 길이를 입력하세요 : ");
        int size = sc.nextInt();

        double[] darr = new double[size];

        System.out.println("darr의 hashcode : " + darr.hashCode()); //1638172114
        System.out.println("darr의 길이 : "+ darr.length);

        darr = new double[30]; //방갯수를 초기화

        System.out.println("변경후 darr의 hashcode : " + darr.hashCode()); //972765878
        System.out.println("darr의 길이 : "+ darr.length);
        
        darr = null;
        System.out.println("darr.length = " + darr.length); //null으로 끊어주면서 주소값 잃어버림
        //오래되면 heap으로 넘어가서 garbage collector에서 지워줌 ..
