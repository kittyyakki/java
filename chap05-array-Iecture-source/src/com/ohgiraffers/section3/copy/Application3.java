...
public class Application3 {
    public static void main(String[] args) {
        ...
        *  서로 다른 값을 가지고 있지만, 두 배열은 서로 다른 배열이기 때문에
        ...
        *  이 중에 가장 높은 성능을 보이는 것은 순수 배열의 복사를 위해 만들어진 arraycopy()메소드 이며,
        *  가장 많이 사용되는 방식은 좀 더 유연한 방식은 copyOf() 메소드 이다.
        *  clone()은 이전 배열과 같은 배열 밖에 만들 수 없다는 특징을 가지고
        *  그 외 3가지 방법은 복사하는 배열의 길이를 마음대로 조절할 수 있다는 특징을 가지고 있다.
        * */

        int[] originArr =  new int[]{1,2,3,4,5}; //할당 및 초기화
        ...
        /* 2. Object의 clone() 이용한 복사 */
        int[] copyArr2 = originArr.clone();

        print(copyArr2);

        /* 3. System의 arraycopy() 이용한 복사 */
