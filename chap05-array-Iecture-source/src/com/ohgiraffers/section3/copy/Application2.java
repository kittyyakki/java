...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 2. 리턴값으로 활용 */
        String[] animals = getAnimals(); //static method라 class로 불어오기 가능.
        System.out.println("return받은 animals.hashCode() = " + animals.hashCode());
    ...
    public static String[] getAnimals(){
        ...
        System.out.println("새로 만든 animals의 hashcod " + animals.hashCode());
        return animals;
    }
}
