...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        *  선언과 동시에 모두 배열을 할당할수 없으며 할당할 배열의 갯수만 지정하고 각 인덱스에 서로다른
        *  길이의 배열을 따로 할당해야 한다.
        ...
        * */
        ...
        int [][] iarr = new int[3][]; //방의 길이다 달라서 뒤에 선언 못해줌!
        ...
        int[] arr = new int[5]; //미리 할당해둔 배열을 활용할수 있다
        iarr[2] = arr; //변수도 안에 넣어줄수 있다.
