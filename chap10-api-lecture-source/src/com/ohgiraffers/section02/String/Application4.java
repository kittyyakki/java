...
public class Application4 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("안녕하세요 저는\t선덕여왕 입니다.");

        System.out.println("안녕하세요 저는 '이순신' 입니다.");
        //System.out.println(''''); //empty character literal 홀따옴표 문자와 리터럴 기호가 중복됨
        System.out.println('\'');

        //System.out.println("안녕하세요 저는 "오나라" 입니다."); //문자열 리터럴과 중복되어 에러남
