...
public class Application {
    public static void main(String[] args) {
        ...
        /*
        * 상황에 따라 기본타입의 데이터를 인스턴스화 해야 하는 경우가 발생한다
        ...
        * */
        ...
        Integer boxingNum2 = Integer.valueOf(intValue); //static 메소드 이용 //방식한 것임!!

        int unBoxingNum1 = boxingNum.intValue();        //언박싱 // intValue()메소드 이용
        ...
        * */
        ...
        Integer integerNum2 = new Integer(20); //Wrapper클래스
