...
public class Application {
    public static void main(String[] args) {
         ...
         *    이런 동일한 메세지를 수신받아 처리하는 내용을 객체별로 다르게 할 수 있다는 장점을 가지고 잇다.
         *    (다양한 기능을 사용하는데 있어서 관리해아할 메세지 종류가 줄어들게 된다)
         ...
         * 4. 결합도를 낮춰서 유지 보수성을 증가시킬 수 있다.  //상속과 다른점.
         * */
        ...
        Animal a1 = new Rabbit(); //new 하면 주소값이 생김
        Tiger a2 = new Tiger();
         ...
         *  런타입 당시의 실제 객체가 가진 오버라이딩된 메소드로 바인딩 바뀌어 동작하는 것을 의미한다.
         * */

        a1.cry();
        a2.cry();

        //a1.jump(); 여기서는 에러가 남 왜냐면 부모타입에는 jump, bite 가 없기 때문에
        //a2.bite();
        ...
        /* 8. instancof 연산자 사용 확인 */
        System.out.println("============instancof============");
        ...
        } //a1이 Rabbit으로 재정의했으니 작동안함.

        /* 9. 클래스의 업캐스팅 다운캐스팅 */
        /*
        * 클래스 형변환은 up-casting down-casting 으로 구분할 수 있다.
        * up-casting : 상위 타입으로의 형변환
        * down-casting : 하위 타입으로의 형변환
        * 또한 작성 여부에 따라서 명시적 묵시적 두가지로 구분된다.
        * */
